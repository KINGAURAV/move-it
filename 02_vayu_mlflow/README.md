...
4. **Note the tracking URL and credentials:** Copy the host URL, username, and password into the root `.env` as `MLFLOW_TRACKING_URL`, `MLFLOW_TRACKING_USERNAME`, and `MLFLOW_TRACKING_PASSWORD` — you will use these in [Step 4](../04_starter-kit/).
