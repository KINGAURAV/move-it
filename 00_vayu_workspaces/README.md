...
1. **Create a Vayu AI Studio Workspace**
   ...
   - After the workspace is **Ready**, configure firewall rules so external clients can reach the workspace **Public Endpoint**. Follow **`Port 443 FW Rule.pdf`** shared with your team.
